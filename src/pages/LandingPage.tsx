...
function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute left-[-8%] top-[-5%] w-[35%] max-w-[400px] animate-float-left pointer-events-none hidden lg:block mix-blend-luminosity">
        <img
          src={handLeftGreen}
          alt=""
      ...
      <div className="absolute right-[-10%] bottom-[15%] w-[35%] max-w-[400px] animate-float-right pointer-events-none hidden lg:block mix-blend-luminosity">
        <img
          src={handRightGreen}
          alt=""
          className="w-full h-auto drop-shadow-2xl"
